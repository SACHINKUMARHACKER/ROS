...
(cl:defmethod time_elapsed-val ((m <TimerResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package-msg:time_elapsed-val is deprecated.  Use my_package-msg:time_elapsed instead.")
  (time_elapsed m))

(cl:ensure-generic-function 'updates_sent-val :lambda-list '(m))
(cl:defmethod updates_sent-val ((m <TimerResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package-msg:updates_sent-val is deprecated.  Use my_package-msg:updates_sent instead.")
  (updates_sent m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TimerResult>)))
  ...
  "73a8afdb7f25336c2256cbe593cce7a3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TimerResult)))
  "Returns md5sum for a message object of type 'TimerResult"
  "73a8afdb7f25336c2256cbe593cce7a3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# result~%duration time_elapsed~%uint8 updates_sent~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerResult)))
  "Returns full string definition for message of type 'TimerResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# result~%duration time_elapsed~%uint8 updates_sent~%~%~%"))
